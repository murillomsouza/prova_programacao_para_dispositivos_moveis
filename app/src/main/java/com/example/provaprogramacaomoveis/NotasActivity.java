...
public class NotasActivity extends Activity {
    ...
    private void calcularMedia(){
            ...
            try{
                ...
                double prova2 = Double.parseDouble(valorProva1.replace(",","."));;
                double trabalho = Double.parseDouble(valorProva1.replace(",","."));;
                double atividade = Double.parseDouble(valorProva1.replace(",","."));;
